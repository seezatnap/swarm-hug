...
- [ ] (#10) Implement the missing `src/process_group.rs` (`spawn_in_new_process_group`) and wire `claude.rs`/`codex.rs` spawns to use it; #4 is marked complete but the module/function aren’t present.
