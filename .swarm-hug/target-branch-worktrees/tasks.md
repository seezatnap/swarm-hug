...
- [ ] (#1) Add shared target worktrees root directory creation at `./swarm-hub/.shared/worktrees`, ensuring the directory exists before any target worktree operations, and implement utility function to get the shared worktrees root path [5 pts]
