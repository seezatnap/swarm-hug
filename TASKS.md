...
- [x] (#5) Emit a "post-mortem started" chat entry when the post-mortem agent begins processing (include tests)
- [x] (#6) Update sprint follow-up ticket generator to output prd-to-task format `- [ ] (#N) description (blocked by #M)` with proper numbering and blocked-by list (include tests)
